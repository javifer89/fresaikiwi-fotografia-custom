        ...
        <section className="relative h-[60vh] min-h-[400px] flex items-center">
          ...
          <Container className="relative z-10">
            ...
            <p className="text-xl text-white/90 mt-4 max-w-xl animate-fade-in-up delay-100">
              Celebra cada aÃ±o con fotos llenas de alegrÃ­a
            </p>
          </Container>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-gray-600 mt-4 leading-relaxed">
                  Las sesiones de cumpleaÃ±os son perfectas para capturar la esencia 
                  de cada edad. Desde el primer cumpleaÃ±os con su tarta protagonista 
                  hasta cumpleaÃ±os temÃ¡ticos llenos de diversiÃ³n.
                </p>
                <p className="text-gray-600 mt-4 leading-relaxed">
                  Podemos crear sesiones con temÃ¡tica personalizada, decoraciÃ³n 
                  temÃ¡tica y todos los detalles que hagan especial ese dÃ­a.
                </p>
              </div>
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <ul className="space-y-3 text-gray-600">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-[var(--accent)] rounded-full" />
                    DecoraciÃ³n temÃ¡tica disponible
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-[var(--accent)] rounded-full" />
