        ...
        <section className="relative h-[60vh] min-h-[400px] flex items-center">
          ...
          <Container className="relative z-10">
            ...
            <p className="text-xl text-white/90 mt-4 max-w-xl animate-fade-in-up delay-100">
              Los primeros dÃ­as de vida, capturados con ternura
            </p>
          </Container>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-gray-600 mt-4 leading-relaxed">
                  Las sesiones newborn se realizan durante los primeros 15 dÃ­as de vida 
                  del bebÃ©, cuando duermen profundamente y podemos colocarlos en las 
                  posturas mÃ¡s tiernas y seguras.
                </p>
                <p className="text-gray-600 mt-4 leading-relaxed">
                  Disponemos de todo tipo de accesorios, fundas y props para crear 
                  imÃ¡genes Ãºnicas y personalizadas. La seguridad del bebÃ© es siempre 
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-center gap-2">
                    ...
                    DuraciÃ³n de 2-3 horas
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-[var(--accent)] rounded-full" />
                    20-30 fotos editadas en alta resoluciÃ³n
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-[var(--accent)] rounded-full" />
