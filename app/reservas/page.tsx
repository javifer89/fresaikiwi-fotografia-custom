...
export default function ReservasPage() {
  // Función para abrir la página de reservas en nueva pestaña
  const handleReserva = () => {
    window.open(
      'https://ohmyphoto.app/reservas/489/2317/fresaikiwifotografia',
      '_blank',
      'noopener,noreferrer'
    );
  };
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              ...
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <p className="text-sm text-gray-600" style={{ fontFamily: "'Roboto', sans-serif" }}>Confirmaremos la disponibilidad</p>
              </div>
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <p className="text-sm text-gray-600" style={{ fontFamily: "'Roboto', sans-serif" }}>Reservamos tu fecha y empezamos a planificar la sesión</p>
              </div>
            </div>

            {/* Booking Section - Botón en lugar de iframe */}
            <div className="bg-white p-4 md:p-6 rounded-2xl shadow-xl overflow-hidden text-center">
              <h2 className="text-3xl font-bold mb-6" style={{ fontFamily: "'Rouge Script', cursive", color: '#3D3D3D' }}>
                Reserva tu sesión
              </h2>
              ...
              <p className="text-gray-600 mb-8" style={{ fontFamily: "'Roboto', sans-serif" }}>
                Haz clic en el botón para abrir el sistema de reservas en una nueva ventana
              </p>

              {/* Botón de reserva con diseño acorde a tu marca */}
              <button
                onClick={handleReserva}
                className="bg-[#E8A4A4] hover:bg-[#D48888] text-white font-bold py-4 px-10 rounded-2xl text-lg transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 inline-flex items-center gap-3"
              ...
              {/* Icono de nueva ventana como indicador visual */}
              <div className="mt-4 text-sm text-gray-500" style={{ fontFamily: "'Roboto', sans-serif" }}>
            ...
            {/* CODIGO PARA 2 CARDS
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg"></div> */}
            <div className="flex justify-center mt-12">
              <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg max-w-2xl w-full">
