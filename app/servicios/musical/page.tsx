        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg leading-relaxed mb-8" style={{color: '#6B6B6B', fontFamily: "'Roboto', sans-serif"}}>
              Las sesiones musicales son perfectas para capturar la esencia de bandas, solistas 
              o cualquier proyecto musical. Creamos imágenes que reflejan tu estilo y personalidad 
              artística, ideales para portadas de álbumes, material promocional y redes sociales.
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <div className="bg-white px-6 py-3 rounded-full shadow-lg">
                <span className="font-semibold" style={{color: FRESA_DARK, fontFamily: "'Roboto', sans-serif"}}>30+ fotos editadas</span>
              </div>
              <div className="bg-white px-6 py-3 rounded-full shadow-lg">
                <span className="font-semibold" style={{color: FRESA_DARK, fontFamily: "'Roboto', sans-serif"}}>Edición profesional</span>
              </div>
            </div>
          </div>
        </Container>
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-white/90 mb-8 max-w-xl mx-auto" style={{fontFamily: "'Roboto', sans-serif"}}>
              Contacta con nosotras y empecemos a planificar tu sesión musical.
            </p>
            <Link
              href="/reservas"
