        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg leading-relaxed mb-8" style={{color: '#6B6B6B', fontFamily: "'Roboto', sans-serif"}}>
              Las fiestas de Moros y Cristianos son una tradición única que merece ser inmortalizada. 
              Capturamos la esencia, el color y la emoción de estas celebraciones con sesiones 
              que reflejan el orgullo y la tradición de esta fiesta típica.
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <div className="bg-white px-6 py-3 rounded-full shadow-lg">
                <span className="font-semibold" style={{color: FRESA_DARK, fontFamily: "'Roboto', sans-serif"}}>Álbum digital</span>
              </div>
            </div>
          </div>
        </Container>
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-white/90 mb-8 max-w-xl mx-auto" style={{fontFamily: "'Roboto', sans-serif"}}>
              Contacta con nosotras y empecemos a planificar tu sesión de Moros y Cristianos.
            </p>
            <Link
              href="/reservas"
