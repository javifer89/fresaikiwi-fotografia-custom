...
const embarazoImages = [
  "https://rxdpvfeqdbenrlupzewy.supabase.co/storage/v1/object/public/assets/RAQUEL_EMB_PROBA-78%20copia.jpg",
  "https://rxdpvfeqdbenrlupzewy.supabase.co/storage/v1/object/public/assets/ELENA_EMB-134%20copia%202.jpg",
  "https://rxdpvfeqdbenrlupzewy.supabase.co/storage/v1/object/public/assets/EUGE_EMB-8.jpg",
  "https://rxdpvfeqdbenrlupzewy.supabase.co/storage/v1/object/public/assets/CRIS_SANZ-16%20copia.jpg",
];
      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:items-start mb-16">
          <div>
            ...
            <h1 className="text-fluid-2xl font-bold mb-4" style={{ fontFamily: "'Rouge Script', cursive", color: '#3D3D3D' }}>
              Embarazo
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {embarazoImages.map((src, index) => (
              <div
                ...
                className="relative rounded-xl overflow-hidden cursor-pointer aspect-[3/4] bg-gray-200 group"
              >
                <Image
                  src={src}
